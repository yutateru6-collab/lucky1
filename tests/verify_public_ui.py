...
with sync_playwright() as p:
    ...
    expect(page.locator('body')).to_have_attribute('data-version','4.0.0')
    ...
    q=desktop.new_page();q.goto(URL,wait_until='networkidle');expect(q.locator('body')).to_have_attribute('data-version','4.0.0')
