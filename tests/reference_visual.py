...
try:
    ...
    with sync_playwright() as p:
        ...
        check('version is 4.0.4', page.locator('meta[name="lucky-version"]').get_attribute('content')=='4.0.4')
        ...
        page.locator('#quick-start-home').click()
        dialog_bg=page.locator('#quick-dialog').evaluate("el=>getComputedStyle(el).backgroundColor")
        check('quick modal stays bright even when app theme is dark', dialog_bg=='rgb(255, 250, 253)')
        page.screenshot(path=str(OUT/'reference-quick-bright-on-dark-390.png'),full_page=True)
        page.locator('#quick-close').click()
