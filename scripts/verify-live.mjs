...
const version = '4.0.7';
const paths = ['index.html', 'app.mjs', 'quick-mode.mjs', 'styles.css', 'quick-mode.css', 'visuals.mjs', 'vendor/anime.esm.min.js', 'art/lucky-reference.webp', 'games.mjs', 'journal.mjs', 'words.mjs', 'sw.js'];
